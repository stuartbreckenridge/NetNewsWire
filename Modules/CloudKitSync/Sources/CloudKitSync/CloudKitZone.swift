...
public enum CloudKitZoneError: LocalizedError, Sendable {
	...
	public var errorDescription: String? {
		switch self {
		case .userDeletedZone:
			return Localizations.labelTextTheIcloudDataWasDeletedPleaseRemoveTheApplicationIcloudAccountAndAddItAgainToContinueUsingTheApplicationSIcloudSupport
		case .corruptAccount:
			return Localizations.labelTextThereIsAnUnrecoverableProblemWithYourApplicationIcloudAccountPleaseMakeSureYouHaveIcloudAndIcloudDriveEnabledInSystemPreferencesThenRemoveTheApplicationIcloudAccountAndAddItAgain
		default:
